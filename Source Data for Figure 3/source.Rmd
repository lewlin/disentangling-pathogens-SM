---
title: Statistical analysis for *Disentangling bacterial invasiveness from lethality in an experimental host-pathogen system*
...
```{r}
rm(list=ls())
wd1 <- '/Users/tbiancal/git/disentangling-pathogens-SM/exp1/'
wd2 <- '/Users/tbiancal/git/disentangling-pathogens-SM/exp2/'
```
